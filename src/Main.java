...
public class Main {
	//Constantes que definem os comandos
	 ...
	 public static final String PHONE_NUM_NOT_EXIST = "Phone number does not exist.";
	...
	private static void getNumber(Scanner in, ContactBook cBook) {
		...
		if(cBook.hasName(phoneNumber) == true) {
			System.out.println(cBook.getName(phoneNumber));
		}else {
			System.out.println(PHONE_NUM_NOT_EXIST);
		}
	}
	private static void existsPhone(ContactBook cBook ) {
		
		if(cBook.existsSamePhones() == true) {
